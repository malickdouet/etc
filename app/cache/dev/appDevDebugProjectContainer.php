...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'khepin.yaml_loader' => 'getKhepin_YamlLoaderService',
            ...
            'security.authentication.session_strategy.default' => 'getSecurity_Authentication_SessionStrategy_DefaultService',
            ...
            'unsecure.listener.add_session_data_twig_global' => 'getUnsecure_Listener_AddSessionDataTwigGlobalService',
            'unsecure.login' => 'getUnsecure_LoginService',
            'unsecure.repository.session' => 'getUnsecure_Repository_SessionService',
            'unsecure.repository.user' => 'getUnsecure_Repository_UserService',
            'unsecure.session' => 'getUnsecure_SessionService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UnsecureBundle', ($this->targetDirs[2].'/Resources/UnsecureBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UnsecureBundle', '/app/src/UnsecureBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => $this->get('kernel.class_cache.cache_warmer'), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array('/app/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form' => NULL)), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array('/app/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form' => NULL))), 7 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'unsecure.session', 1 => 'onKernelController'), 0);
        $instance->addListenerService('kernel.response', array(0 => 'unsecure.session', 1 => 'onKernelResponse'), 0);
        $instance->addListenerService('kernel.controller', array(0 => 'unsecure.listener.add_session_data_twig_global', 1 => 'onKernelController'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mariadb', 'port' => NULL, 'dbname' => 'vse_khorosho', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/app/src/UnsecureBundle/Entity')), 'UnsecureBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('UnsecureBundle' => 'UnsecureBundle\\Entity'));
    ...
    /**
     * Gets the public 'khepin.yaml_loader' shared service.
     *
     * @return \Khepin\YamlFixturesBundle\Loader\YamlLoader
     */
    protected function getKhepin_YamlLoaderService()
    {
        return $this->services['khepin.yaml_loader'] = new \Khepin\YamlFixturesBundle\Loader\YamlLoader($this->get('kernel'), array(0 => 'UnsecureBundle/user', 1 => 'UnsecureBundle/subject', 2 => 'UnsecureBundle/comment', 3 => 'UnsecureBundle'), 'Resources/fixtures');
    }
    ...
    protected function getSecurity_Authentication_GuardHandlerService()
    {
        ...
        $instance->setSessionAuthenticationStrategy($this->get('security.authentication.session_strategy.default'));

        return $instance;
    }

    /**
     * Gets the public 'security.authentication.session_strategy.default' shared service.
     *
     * @return \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy
     */
    protected function getSecurity_Authentication_SessionStrategy_DefaultService()
    {
        return $this->services['security.authentication.session_strategy.default'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($e, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array())), 'default', $a, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5bda2b7bb74b06.58263449', $a, $c), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $e, $c)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($d, $d, '{^https?://%s$}i'), 'default', NULL, NULL, NULL, $a, false), NULL);
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'UnsecureBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/app/src/UnsecureBundle/Resources/views', 'Unsecure');
    ...
    /**
     * Gets the public 'unsecure.listener.add_session_data_twig_global' shared service.
     *
     * @return \UnsecureBundle\Listener\AddSessionDataTwigGlobal
     */
    protected function getUnsecure_Listener_AddSessionDataTwigGlobalService()
    {
        return $this->services['unsecure.listener.add_session_data_twig_global'] = new \UnsecureBundle\Listener\AddSessionDataTwigGlobal($this->get('unsecure.session'), $this->get('twig'));
    }

    /**
     * Gets the public 'unsecure.login' shared service.
     *
     * @return \UnsecureBundle\Service\LoginService
     */
    protected function getUnsecure_LoginService()
    {
        return $this->services['unsecure.login'] = new \UnsecureBundle\Service\LoginService($this->get('unsecure.repository.user'));
    }

    /**
     * Gets the public 'unsecure.repository.session' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getUnsecure_Repository_SessionService()
    {
        return $this->services['unsecure.repository.session'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('UnsecureBundle\\Entity\\Session');
    }

    /**
     * Gets the public 'unsecure.repository.user' shared service.
     *
     * @return \Doctrine\ORM\EntityRepository
     */
    protected function getUnsecure_Repository_UserService()
    {
        return $this->services['unsecure.repository.user'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('UnsecureBundle\\Entity\\User');
    }

    /**
     * Gets the public 'unsecure.session' shared service.
     *
     * @return \UnsecureBundle\Service\SessionService
     */
    protected function getUnsecure_SessionService()
    {
        return $this->services['unsecure.session'] = new \UnsecureBundle\Service\SessionService($this->get('request_stack'), $this->get('unsecure.repository.session'), $this->get('unsecure.repository.user'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bda2b7bb74b06.58263449')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UnsecureBundle' => 'UnsecureBundle\\UnsecureBundle',
                'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle',
                'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle',
                'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle',
                'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'KhepinYamlFixturesBundle' => 'Khepin\\YamlFixturesBundle\\KhepinYamlFixturesBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'UnsecureBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/src/UnsecureBundle',
                ...
                'SensioDistributionBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle',
                    'namespace' => 'Sensio\\Bundle\\DistributionBundle',
                ),
                'SensioGeneratorBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle',
                ...
                'KhepinYamlFixturesBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/khepin/yaml-fixtures-bundle/Khepin/YamlFixturesBundle',
            ...
            'khepin_yaml_fixtures.resources' => array(
                0 => 'UnsecureBundle/user',
                1 => 'UnsecureBundle/subject',
                2 => 'UnsecureBundle/comment',
                3 => 'UnsecureBundle',
            ),
            'khepin_yaml_fixtures.acl_manager' => '',
            'khepin_yaml_fixtures.directory' => 'Resources/fixtures',
